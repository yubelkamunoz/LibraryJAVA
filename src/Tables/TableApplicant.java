...
public class TableApplicant extends javax.swing.JFrame {

    public TableApplicant() {
        initComponents();
        this.setSize( 600, 400);
        this.setLocationRelativeTo(null);
        this.setTitle("BILIOTECA IUT-- Lista de Solicitantes");
    ...
    public void mostrar(){
        ...
        ResultSet rs = Conecction.getTable("SELECT * FROM applicant");
        //JButton btn_modificar = new JButton("Modificar");
        //System.exit(rs);
        modelo.setColumnIdentifiers(new Object[]{"","Cod","Nombre","Apellido","Fecha de Nacimiento","Telefono","Sexo","Solicitante","Creacion"});
        try{
            while(rs.next()){
                modelo.addRow(new Object[]{rs.getString("cod_app"),rs.getString("nro_app"),rs.getString("name_app"),rs.getString("surn_app"),rs.getString("datebir_app"),rs.getString("phon_app"),rs.getString("sex_app"),rs.getString("type_app"),rs.getString("datecrea_app")});
    ...
    private void initComponents() {
        ...
        jTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "", "Cod", "Nombre", "Apellido", "Fecha de Nac.", "Telefono", "Sexo", "Tipo", "Creacion"
            }
        ) {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/listasolicitante2.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TableApplicant.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TableApplicant().setVisible(true);
            }
        });
    }
