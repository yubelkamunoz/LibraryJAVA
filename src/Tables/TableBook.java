...
public class TableBook extends javax.swing.JFrame {
    ...
    public TableBook() {
        ...
        this.setTitle("BILIOTECA IUT-- Lista de Libros");
    ...
    public void mostrar(){
        ...
        //System.exit(rs);
        modelo.setColumnIdentifiers(new Object[]{"","Cod","nombre","Editorial","Año","Ubicacion","Tipo","Area","Estado"});
        try{
            while(rs.next()){
                modelo.addRow(new Object[]{rs.getString("cod_book"),rs.getString("nro_book"),rs.getString("name_book"),rs.getString("edit_book"),rs.getString("year_book"),rs.getString("locat_book"),rs.getString("type_book"),rs.getString("area_book"),rs.getString("avai_book"),rs.getString("cod_book"),rs.getString("cod_book")});
    ...
    private void initComponents() {
        ...
        jTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "", "Cod", "Nombre", "Editorial", "Año", "Ubicacion", "Tipo de Libro", "Area", "Estado"
            }
        ) {
        ...
        jPanel1.add(jtProductos, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 560, 180));
        ...
        jPanel1.add(txtBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 100, 160, 30));
        ...
        jPanel1.add(btnBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 100, 100, 30));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/listalibro2.png"))); // NOI18N
        ...
        jPanel1.add(rdcodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 50, -1, -1));
        ...
        jPanel1.add(rdlibro, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 50, -1, -1));
        ...
        jPanel1.add(rdcategoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 50, -1, -1));
        ...
        jPanel1.add(rdNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 50, -1, -1));
