...
public class FormApplicant extends javax.swing.JFrame {
     ...
     private void Limpiar(){
        ...
        dcfecha_devolucion.setToolTipText(null);
    ...
    private void initComponents() {
        ...
        jPForm.add(dcfecha_devolucion, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 160, 120, 30));

        txtAnio.setText("AA/MM/DD");
        jPForm.add(txtAnio, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 160, 60, 30));
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 200, 180, 140));
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        try{
            ...
            if(res.next()){
                ...
                dcfecha_devolucion.setToolTipText(res.getString("datebir_app"));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
            ...
            ps.setString(4, dcfecha_devolucion.getDateFormatString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormApplicant.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
